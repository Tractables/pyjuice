...
def test_cat_soft_cond():
    ...
    p0 = data[0,0,0] * pc.input_layer_group[0].params[0] + data[0,0,1] * pc.input_layer_group[0].params[1]
    p1 = data[0,0,0] * pc.input_layer_group[0].params[2] + data[0,0,1] * pc.input_layer_group[0].params[3]
    ...
    unnorm_o = f1 * pc.input_layer_group[0].params[4:8] + f2 * pc.input_layer_group[0].params[8:12]
